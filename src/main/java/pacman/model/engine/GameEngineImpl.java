...
public class GameEngineImpl implements GameEngine {
    ...
    private RenderableFactoryRegistry getRenderableFactoryRegistry() {
        ...
        renderableFactoryRegistry.registerFactory(RenderableType.BLINKY_GHOST, new GhostFactory(RenderableType.BLINKY_GHOST));
        renderableFactoryRegistry.registerFactory(RenderableType.INKY_GHOST, new GhostFactory(RenderableType.INKY_GHOST));
        renderableFactoryRegistry.registerFactory(RenderableType.CLYDE_GHOST, new GhostFactory(RenderableType.CLYDE_GHOST));
        renderableFactoryRegistry.registerFactory(RenderableType.PINKY_GHOST, new GhostFactory(RenderableType.PINKY_GHOST));
